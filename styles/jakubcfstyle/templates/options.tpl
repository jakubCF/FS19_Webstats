	...
	<div class="row">
		...
		<div class="col-md-6 col-lg-4">
			...
			<div class="input-group mb-3 hoverhelp" data-helptext="##AUTO_RELOAD_HELP##">
				...
				<div class="col-md-6 col-lg-4">
			<label for="basic-url">##CURRENCY##</label>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					<button class="btn btn-outline-secondary back-button" type="button" data-id="g_currency">&#11207;</button>
				</div>
				<select class="custom-select text-center" name="g_currency" id="g_currency">
					<option value="USD" {if $options.general.currency=="USD"}selected{/if}>USD</option>
					<option value="EUR" {if $options.general.currency=="EUR"}selected{/if}>EUR</option>
					<option value="CZK" {if $options.general.currency=="CZK"}selected{/if}>CZK</option>
				</select>
				<div class="input-group-append">
					<button class="btn btn-outline-secondary next-button" type="button" data-id="g_currency">&#11208;</button>
				</div>
			</div>
		</div>
		<div class="col-md-6 col-lg-4">
